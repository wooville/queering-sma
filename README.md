## Overview
This is (currently) a simple Python program that simulates [the multi-agent model of slime mold initially designed by Jeff Jones](https://pubmed.ncbi.nlm.nih.gov/20067403/).
